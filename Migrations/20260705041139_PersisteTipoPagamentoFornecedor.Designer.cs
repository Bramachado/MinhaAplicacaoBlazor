...
namespace MinhaAplicacaoBlazor.Migrations
{
    ...
    [Migration("20260705041139_PersisteTipoPagamentoFornecedor")]
    partial class PersisteTipoPagamentoFornecedor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Crm.CrmContato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Contatos", "crm");
                });

            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Crm.CrmEtapaFunil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EtapasFunil", "crm");
                });

            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Crm.CrmOportunidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CrmContatoId")
                        .HasColumnType("int");

                    b.Property<int>("CrmEtapaFunilId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CrmContatoId");

                    b.HasIndex("CrmEtapaFunilId");

                    b.HasIndex("ResponsavelUserId");

                    b.ToTable("Oportunidades", "crm");
                });
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Crm.CrmOportunidade", b =>
                {
                    b.HasOne("MinhaAplicacaoBlazor.Models.Crm.CrmContato", "Contato")
                        .WithMany()
                        .HasForeignKey("CrmContatoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MinhaAplicacaoBlazor.Models.Crm.CrmEtapaFunil", "Etapa")
                        .WithMany()
                        .HasForeignKey("CrmEtapaFunilId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
