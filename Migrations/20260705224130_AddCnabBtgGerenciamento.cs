...
{
    /// <inheritdoc />
    public partial class AddCnabBtgGerenciamento : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoGeracao = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    BancoCadastroId = table.Column<int>(type: "int", nullable: true),
                    BancoCadastroNome = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ValorTotalCompetencia = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    ValorTotalSelecionado = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    ValorTotalGerado = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    ValorTotalBoletos = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    ValorTotalInvalidos = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    QuantidadeTotalCompetencia = table.Column<int>(type: "int", nullable: false),
                    QuantidadeSelecionada = table.Column<int>(type: "int", nullable: false),
                    QuantidadeBoletos = table.Column<int>(type: "int", nullable: false),
