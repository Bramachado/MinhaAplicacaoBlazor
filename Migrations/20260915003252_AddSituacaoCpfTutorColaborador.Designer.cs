...
namespace MinhaAplicacaoBlazor.Migrations
{
    ...
    [Migration("20260915003252_AddSituacaoCpfTutorColaborador")]
    partial class AddSituacaoCpfTutorColaborador
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Arquivo", b =>
                {
                    ...
                    b.Property<int?>("FolhaFornecedorItemNotaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FolhaFornecedorItemNotaId");
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.FolhaFornecedorItemNota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FolhasFornecedoresItensNotas");
                });
            ...
            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Arquivo", b =>
                {
                    b.HasOne("MinhaAplicacaoBlazor.Models.Empresa", null)
                        .WithMany()
                    ...
                    b.HasOne("MinhaAplicacaoBlazor.Models.FolhaFornecedorItemNota", "FolhaFornecedorItemNota")
                        .WithMany("Arquivos")
                        .HasForeignKey("FolhaFornecedorItemNotaId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("FolhaFornecedorItemNota");
                });

            modelBuilder.Entity("MinhaAplicacaoBlazor.Models.Auth.ApplicationUser", b =>
                {
                    b.HasOne("MinhaAplicacaoBlazor.Models.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
