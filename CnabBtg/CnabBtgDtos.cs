...
public sealed class CnabBtgGerarRequest
{
    ...
    /// <summary>
    /// Quando true, permite reincluir pagamentos que já estão em um CNAB ativo
    /// (útil em testes: gerar o mesmo arquivo várias vezes). Padrão false.
    /// </summary>
    public bool PermitirRegerar { get; set; }

    // === Totais de conferência da tela "Gerenciar CNAB" (para auditoria/histórico) ===
